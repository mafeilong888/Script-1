...
let keepkey = '',uid=''
if ($.isNode()) {
     keepurlArr.push('https://www.xiaeke.com/benmao/index.php/Home/MorningTree/gainEnergy?user_id=61527&energy_type=0&energy=10')
     keephdArr.push('{"Accept":"*/*","Accept-Encoding":"gzip, deflate, br","Connection":"keep-alive","Referer":"https://servicewechat.com/wx78f529e29468199b/19/page-frame.html","Content-Type":"application/json","Host":"www.xiaeke.com","User-Agent":"Mozilla/5.0 (iPhone; CPU iPhone OS 14_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 MicroMessenger/8.0.3(0x1800032a) NetType/WIFI Language/zh_CN","Accept-Language":"zh-cn"}')
...
function keepjs(timeout = 0) {
  return new Promise((resolve) => {
uid=keepurl.match(/user_id=(.*?)&/)[1]
let url = {
        url : `https://www.xiaeke.com/benmao/index.php/Home/MorningTree/gainEnergy?user_id=${uid}&energy_type=0&energy=10`,

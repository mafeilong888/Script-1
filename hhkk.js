...
if ($.isNode()) { 
 ...
 hhkkbodyArr.push('ids=&token=4902e25bd96d60ad551cc0fde15abcea&userid=92632004&auth_key=_t_5i0nyj_j3mXEBqSUc4BwnAHC6pn60_1619516075_92632004&app_version=1.1.1&app_os=iOS')
hhkkhdArr.push('{"Accept":"*/*","Accept-Encoding":"gzip, deflate, br","Connection":"keep-alive","Content-Type":"application/x-www-form-urlencoded","Host":"api.mozillacoin.com","User-Agent":"iPhone12,1(iOS/14.4) Uninview(Uninview/1.0.0) Weex/0.26.0 828x1792","Content-Length":"150","Accept-Language":"zh-cn"}')
 hhkkurlArr.push('https://api.mozillacoin.com/main/main?type=hot')
...
function hhkkck() {
  ...
  $.log(hhkkbody)
  const hhkkurl = $request.url
  if(hhkkurl)     $.setdata(hhkkurl,`hhkkurl${status}`)
  $.log(hhkkurl)
  const hhkkhd = JSON.stringify($request.headers)

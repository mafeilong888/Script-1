...
const cgwzurlArr = [], cgwzggurlArr = [],cgwzhdArr = [],cgwzcount = ''
let times = Math.round(Date.now() / 1000)
let cgwzurl = $.getdata('cgwzurl')
let cgwzhd = $.getdata('cgwzhd')
let cgwzggurl = $.getdata('cgwzggurl')
if ($.isNode()) {
    cgwzurlArr.push('https://api.litemob.com/caigewangzhe_ios/song/info?uid=179180&is_test=0')
    cgwzhdArr.push('{"Accept-Encoding":"gzip, deflate, br","Accept":"*/*","Connection":"keep-alive","Host":"api.litemob.com","User-Agent":"cai ge wang zhe/1.3.0 (iPhone; iOS 14.4; Scale/2.00)","version":"1.3.0","Accept-Language":"zh-Hans-CN;q=1"}')

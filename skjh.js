...
if ($.isNode()) {
    skjhhdArr.push('{"Connection":"keep-alive","Accept-Encoding":"gzip, deflate, br","X-Auth-Platform":"ios","Content-Type":"application/x-www-form-urlencoded","X-Auth-Token":"1e4a3272-871b-4e80-aaf4-e1d3b7725e2a","User-Agent":"iPhone12,1(iOS/14.4) Uninview(Uninview/1.0.0) Weex/0.26.0 828x1792","X-Auth-Clientid":"","Host":"www.shikeshijie.com","X-Auth-Version":"1.5.0","Accept-Language":"zh-CN,zh;q=0.9,en;q=0.8","Accept":"*/*","Content-Length":"0"}')

...
睡眠赚无限刷
添加重写和mitm
使用方法，商店搜索睡眠赚下载，点击首页，喝水，点击钻石，点领取翻倍,看一个广告获得数据，刷起来吧，0.3提现我测试是秒到，其他到不到账看脸
[task_local]
#睡眠赚无限刷
5,35 9-22 * * * https://raw.githubusercontent.com/age174/-/main/smz.js, tag=睡眠赚无限刷, img-url=https://ae01.alicdn.com/kf/Uaade4566dd3744299956aa883f225386u.jpg, enabled=true
...
let jc = 0
if ($.isNode()) {
     ygkcurlArr.push('coin=8&device=ios&double=0&imei=cef2bc500b30e902462211772c6965d81bfeb391&source=ios&uid=1286340&version=1.0.7')
     ygkchdArr.push('{"Cookie":"PHPSESSID=78079dff7ef8fbaf8063b2c8ffebd0dd; sleep_zouluzhuan=sleep181","Accept":"*/*","Connection":"keep-alive","Content-Type":"application/x-www-form-urlencoded","Accept-Encoding":"gzip, deflate","Host":"sleep.zouluzhuan.com","User-Agent":"SMMon/1.0.7 (iPhone; iOS 14.4; Scale/2.00)","Content-Length":"109","Accept-Language":"zh-Hans-CN;q=1"}')
...
function ygkcck() {
   if ($request.url.indexOf("randCoin") > -1) {
 const ygkcurl = $request.body

...
if ($.isNode()) {
    wcydurlArr.push('http://bxkqemkc.bar/hfTask/startRead')
    wcydhdArr.push('{"X-Requested-With":"XMLHttpRequest","Connection":"keep-alive","Accept-Encoding":"gzip, deflate","Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","Origin":"http://bxkqemkc.bar","User-Agent":"Mozilla/5.0 (iPhone; CPU iPhone OS 14_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 MicroMessenger/8.0.3(0x1800032a) NetType/WIFI Language/zh_CN","Cookie":"JSESSIONID=B74EEA843E86D21FBC9498656AF6DBBA","Host":"bxkqemkc.bar","Referer":"http://bxkqemkc.bar/hfTask/index.html?token=d99ea8b9b0f647a99c13aecf42beb67d","Accept-Language":"zh-cn","Accept":"application/json, text/javascript, */*; q=0.01","Content-Length":"6"}')
